...
export function DriveToday() {
  return (
    <div className="relative mx-auto lg:my-32 max-w-5xl">
      ...
      <Reveal
        position="bottom"
        className="relative z-10 p-8 rounded-md bg-black/[0.96] antialiased bg-grid-white/[0.02] overflow-hidden"
      >
        <Spotlight />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
          ...
          <div className="mx-auto text-center lg:mx-0 lg:text-left max-w-md">
            ...
            <div className="pt-6">
              <Link href="/sign-in">
                <Button className="rounded-full bg-green-500 hover:bg-green-600 px-8 py-3 text-sm font-semibold text-white">
                  Register here
                </Button>
              </Link>
            </div>
      ...
      {/* CAR IMAGE */}
      <Reveal position="right" className="hidden lg:block absolute -right-48 top-1/2 -translate-y-1/2 z-20 pointer-events-none">
        <Image
