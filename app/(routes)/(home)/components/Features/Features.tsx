          ...
          <Reveal key={text} position="bottom" delay={delay}>
            <div
              className="group relative p-6 lg:p-8 rounded-2xl bg-white border border-zinc-100 
                         hover:border-green-200 hover:shadow-lg hover:shadow-green-500/10 
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                >
                  <Icon
                    className="w-7 h-7 lg:w-8 lg:h-8 text-green-600 group-hover:text-green-500 
                ...
                {/* Decorative line */}
                <div
                  className="mt-4 w-8 h-0.5 rounded-full bg-green-500/30 
                              group-hover:w-12 group-hover:bg-green-500 
                              transition-all duration-300"
                />
              </div>
            </div>
