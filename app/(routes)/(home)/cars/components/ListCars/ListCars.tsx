...
import { Fuel, Gauge, Users, Heart, Cog, Check } from "lucide-react";
...
export function ListCars(props: ListCarsProps) {
  ...
  return (
    <>
      {cars.length == 0 && (
        <p>No vehicles with these filters have been found</p>
      )}
          ...
          return (
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-muted/5">
                ...
                <Badge className="absolute top-4 left-4 bg-gradient-to-r from-green-500 to-green-600 
